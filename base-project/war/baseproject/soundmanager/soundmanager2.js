...
function SoundManager(smURL,smID) {
  ...
  this._createMovie = function(smID,smURL) {
    ...
    var htmlEmbed = '<embed name="'+smID+'" id="'+smID+'" src="'+smURL+'" width="0" height="0" quality="high" allowScriptAccess="always" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>';
    var htmlObject = '<object id="'+smID+'" data="'+smURL+'" type="application/x-shockwave-flash" width="0" height="0"><param name="movie" value="'+smURL+'" /><param name="AllowScriptAccess" value="always" /><!-- --></object>';
    ...
    var sHTML = '<div id="sm2-container" style="position:absolute;left:-256px;top:-256px;width:0px;height:0px" class="movieContainer">'+html+'</div>'+(self.debugMode && ((!self._hasConsole||!self.useConsole)||(self.useConsole && self._hasConsole && !self.consoleOnly)) && !document.getElementById(self.debugID)?'x'+debugHTML+toggleElement:'');

	var oTarget = document.getElementById('sm2-container-wrapper');
    ...
    if (oTarget) {
      ...
      self.oMC.style.width = '0px';
      self.oMC.style.height = '0px';
      try {
